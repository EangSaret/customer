...
public class CustomerInfo extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String json = "{\"id\":"+cus.getID()+",\"firstName\":\""+cus.getFName()+"\",\"lastName\":\""+cus.getLName()+
				 "\",\"sex\":\""+cus.getSex()+"\",\"email\":\""+cus.getEmail()+"\",\"dob\":\""+cus.getDOB()+"\",\"address\":\""+cus.getAddress()+"\",\"phone\":\""+cus.getPhone()+"\"}";
		out.print(json);
		out.flush();
